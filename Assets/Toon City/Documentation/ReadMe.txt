...
Added LWRP compatibility from 2019.1 and later.
(when importing the pack in a LWRP project, open the LWRP_Install_Toon City file from the project hierarchy)
