...
(when importing the pack in a URP project, open the "URP_Install_Toon Desert" file from the project hierarchy,
then replace the renderer in the pipeline asset with the "DS_Toon_URP_Renderer" file, which you can find in the Renderer folder).